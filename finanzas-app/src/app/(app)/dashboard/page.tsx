...
export default async function DashboardPage() {
  ...
  return (
    <div className="px-4 sm:px-6 py-4 sm:py-6 max-w-6xl space-y-5 sm:space-y-6">
      <BudgetAlertsBanner />
      <DashboardStats
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2 rounded-2xl border border-white/5 p-5" style={{ background: "rgba(255,255,255,0.02)" }}>
          <h2 className="text-white font-semibold mb-4 text-sm">Ingresos vs Gastos  - últimos 6 meses</h2>
      ...
      <div className="rounded-2xl border border-white/5 p-5" style={{ background: "rgba(255,255,255,0.02)" }}>
        <h2 className="text-white font-semibold mb-4 text-sm">Gastos por categoría  - este mes</h2>
