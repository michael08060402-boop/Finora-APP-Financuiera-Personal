...
export default function CuentasClient() {
  ...
  const getType = (t: string) => WALLET_TYPES.find(wt => wt.value === t) ?? WALLET_TYPES[0];
              ...
              return (
                <motion.div key={w.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.06 }}
                  ...
                  <div className="mt-4 pt-4 border-t border-white/5">
                    <p className="text-slate-500 text-xs uppercase tracking-wider mb-1">Saldo disponible</p>
