      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative">
        ...
        >
          ...
          <div className="glass-card rounded-3xl p-8 lg:p-10">
            <div className="mb-8">
              <h2 className="text-white font-bold text-2xl lg:text-3xl">Bienvenido de vuelta</h2>
              <p className="text-slate-400 mt-1.5 text-sm">Inicia sesión para continuar</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="/forgot-password" className="text-emerald-400 text-xs hover:text-emerald-300 transition-colors">
