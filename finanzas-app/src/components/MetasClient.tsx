                    ...
                    <div>
                      ...
                      {addingId === g.id ? (
                        <div className="flex gap-2">
                          ...
                          <button onClick={() => handleAddAmount(g)} className="btn-primary px-3 py-2 rounded-xl text-white text-sm font-medium">OK</button>
                          <button onClick={() => setAddingId(null)} className="px-3 py-2 rounded-xl bg-white/5 text-slate-400 text-sm">Cancelar</button>
                        </div>
                      ) : (
