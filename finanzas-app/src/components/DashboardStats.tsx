  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: t("dash_total_balance"), value: fmt(balance),      color: balance >= 0 ? "text-emerald-400" : "text-red-400", icon: Wallet,      bg: "border-white/5"      },
          { label: t("dash_total_income"),  value: fmt(totalIncome),  color: "text-emerald-400",                                  icon: TrendingUp,  bg: "border-emerald-500/20" },
          { label: t("dash_total_expense"), value: fmt(totalExpense), color: "text-red-400",                                      icon: TrendingDown, bg: "border-red-500/20"   },
        ].map((c) => (
