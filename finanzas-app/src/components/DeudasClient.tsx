    ...
    <div className="flex-1 min-h-screen" style={{ background: "#080b14" }}>
      ...
      <div className="px-4 sm:px-6 py-4 sm:py-6 border-b border-white/5">
        <div className="flex items-center justify-between gap-2">
          <div>
            <h1 className="text-white font-bold text-xl sm:text-2xl">Deudas y Prestamos</h1>
            <p className="text-slate-500 text-sm mt-0.5 hidden sm:block">Lleva el control de lo que debes y lo que te deben</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="rounded-2xl border border-red-500/15 p-4" style={{ background: "rgba(239,68,68,0.05)" }}>
            <p className="text-slate-500 text-xs mb-1">Yo debo</p>
            <p className="text-red-400 font-bold text-xl">{fmt(iOwe)}</p>
            <p className="text-slate-600 text-xs mt-0.5">pendiente de pagar</p>
          </div>
          <div className="rounded-2xl border border-emerald-500/15 p-4" style={{ background: "rgba(16,185,129,0.05)" }}>
            <p className="text-slate-500 text-xs mb-1">Me deben</p>
            <p className="text-emerald-400 font-bold text-xl">{fmt(owedMe)}</p>
            <p className="text-slate-600 text-xs mt-0.5">pendiente de cobrar</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex gap-2 mt-4">
          {([["all","Todas"], ["i_owe","Yo debo"], ["owed_to_me","Me deben"]] as const).map(([val, lbl]) => (
